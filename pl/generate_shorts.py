...
MP3_FILE = os.environ.get("MP3_FILE")  # workflow sets this (pl/input/*.mp3 or *.mpeg)

IMAGE_DURATION = float(os.environ.get("IMAGE_DURATION", "5"))
ASPECT_RATIO = os.environ.get("ASPECT_RATIO", "9:16")

CHANNEL_NAME = os.environ.get("CHANNEL_NAME", "Paglu's Lab")

OUTPUT_DIR = os.environ.get("OUTPUT_DIR", "pl/output")
...
Topic: Funny / Daily Vlog / Cute Pets (use transcript to infer exact topic)
...
- Hashtags: 5 to 12 total, vlog/pet-relevant, include #shorts, and avoid duplicates.
